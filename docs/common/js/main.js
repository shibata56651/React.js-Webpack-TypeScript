...
function () {
  /**
     ...
     * @returns void
     */
  function SmoothScroll(element, urlHash, options) {
    if (options === void 0) {
      options = {};
    }
  ...
  SmoothScroll.prototype.clickHandler = function (e) {
  ...
  SmoothScroll.prototype.loadHandler = function () {
    if (document.body.clientWidth <= 1170) {
      this.o.HeaderHeight = 87;
    } else {
      this.o.HeaderHeight = 134;
  ...
  SmoothScroll.prototype.scrolling = function () {
    this.scrollFlg = true;
  };
  /**
  ...
  SmoothScroll.prototype.setWatchScrollFlg = function () {
    var _this = this;
  ...
  SmoothScroll.prototype.setFocusTarget = function () {
    if (!this.scrollTarget) {
      return;
    }
...
function () {
  ...
  fade.prototype.scrollHandler = function () {
...
/***/ "./_dev/js/modules/headertoggle.ts":
/*!*****************************************!*\
  !*** ./_dev/js/modules/headertoggle.ts ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, exports) {
...
function () {
  ...
  headertoggle.prototype.init = function () {
    this.element.addEventListener('click', this.clickHandler.bind(this));
  };
  /**
   * トグル機能
  ...
  headertoggle.prototype.clickHandler = function (e) {
    var _this = this;
...
function () {
  ...
  jsonGetData.prototype.init = function () {
  ...
  jsonGetData.prototype.getDataFunc = function () {
    // 取得したレスポンスをページに表示
...
function () {
  ...
  moreShow.prototype.init = function () {
    // モーダル発火
    this.element.addEventListener('click', this.clickHandler.bind(this));
  };
  /**
  ...
  moreShow.prototype.clickHandler = function () {
...
var bundle_1 = __webpack_require__(/*! swiper/bundle */ "./node_modules/swiper/swiper-bundle.esm.js");
/**
 * カルーセル
 */
...
function () {
  ...
  function swiper(element, options) {
    ...
    this.swiper = new bundle_1["default"](this.root, this.o.swiperOptions);
    this.autoPlay = this.swiper.autoplay.running; // autoPlayが有効かどうか

    if (this.autoPlay) {
      this.playBtn = this.root.querySelector(".".concat(this.o.playBtnClass));
      this.playTxt = this.playBtn.querySelector(".".concat(this.o.playTxtClass));
      this.isPlay = false;
    }
  ...
  swiper.prototype.updateActiveSlide = function () {
    /**
       * .currentBreakpointプロパティは、APIが公式で提供しているものではない
       * 現在の画面幅にあたる、swiperのOption（breakpoints）で指定した値を返す
       * 最大値は`max`で返る
       */
    var swiperCurrentBreakpoint = this.swiper.currentBreakpoint;
  ...
  swiper.prototype.resetActiveSlideAttribute = function () {
    for (var i = 0, slideLen = this.swiper.slides.length; i < slideLen; i++) {
      var slide = this.swiper.slides[i];
      var link = slide.querySelectorAll('a');

      for (var _i = 0, link_1 = link; _i < link_1.length; _i++) {
        var tabItem = link_1[_i];
  ...
  swiper.prototype.updateActiveSlideAttribute = function () {
    this.resetActiveSlideAttribute();
    var addActiveSlides = [this.swiper.slides[this.swiper.activeIndex]]; // 本来アクティブなスライドを配列に追加

    var swiperPaginationBullet = document.querySelectorAll('.swiper-pagination-bullet');

    for (var i = 0; i < this.addActiveLength; i++) {
    ...
    for (var _i = 0, addActiveSlides_1 = addActiveSlides; _i < addActiveSlides_1.length; _i++) {
      var slide = addActiveSlides_1[_i];
      var link = slide.querySelectorAll('a');

      for (var _a = 0, link_2 = link; _a < link_2.length; _a++) {
        var tabItem = link_2[_a];
        ...
        if (tabItem) {
          ...
          if (document.querySelector('html body').classList.contains('is-modal-fixed')) {
            ...
            for (var _b = 0, swiperPaginationBullet_1 = swiperPaginationBullet; _b < swiperPaginationBullet_1.length; _b++) {
              var bullet = swiperPaginationBullet_1[_b];
              bullet.tabIndex = '-1';
            }
          }
        } else {
  ...
  swiper.prototype.swiperPlay = function () {
    this.isPlay = true;
  ...
  swiper.prototype.swiperPause = function () {
  ...
  swiper.prototype.playControls = function () {
    if (this.isPlay) {
      // 再生中の場合、一時停止する
      this.swiperPause();
...
function () {
  ...
  */
  ...
  toggle.prototype.clickHandler = function (e) {
    var _this = this;
...
function () {
  ...
  xmlGetData.prototype.init = function () {
    window.addEventListener('DOMContentLoaded', this.getDataFunc.bind(this));
  };
  /**
   * ページロード時にスライドショーを再生する
  ...
  xmlGetData.prototype.getDataFunc = function () {
    // 取得したレスポンスをページに表示
    var _this = this;

    fetch('/common/data/newdata.xml').then(function (response) {
...
var swiper_1 = __webpack_require__(/*! ./modules/swiper */ "./_dev/js/modules/swiper.ts");
...
var headertoggle_1 = __webpack_require__(/*! ./modules/headertoggle */ "./_dev/js/modules/headertoggle.ts");
...
(function (win, doc) {
  ...
  if (swiperTopRoot) {
    new swiper_1.swiper(swiperTopRoot, {
      timer: false,
      swiperOptions: {
        loop: true,
  ...
  var swiperTopAboutRoot = doc.querySelector('.js-swiper-about');

  if (swiperTopAboutRoot) {
    new swiper_1.swiper(swiperTopAboutRoot, {
      timer: false,
      swiperOptions: {
        loop: true,
        loopFillGroupWithBlank: true,
